...
![Package intake and fleet setup](docs/screenshots/01-manifest-intake.png)
...
![Planned routes on the map](docs/screenshots/02-planned-routes.png)
...
![Route cards with stops, timing and cost](docs/screenshots/03-route-cards.png)
...
![Algorithm comparison](docs/screenshots/04-algorithm-comparison.png)
